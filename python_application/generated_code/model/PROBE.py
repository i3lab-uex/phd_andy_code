...
class PROBE:
    ...
    def __init__(
        ...
        Args:
            device (DeviceType): Device type for computations
            dataset (List[Dataset]): List of datasets
            optimization_task (List[OptimizationTask]): List of optimization tasks
        """
        self.device = device
    ...
    def run_optimization_whole_task(self, task_name: str, population_size: int = 100,
        ...
        try:
            ...
            # Create an executor and run optimization for all experiments
            executor = OptimizationExecutor(self)
    ...
    def run_optimization_using_task_experiment(self, task_name: str, experiment_name: str,
        ...
        try:
            ...
            # Create an executor and run optimization for a specific experiment
            executor = OptimizationExecutor(self)
    ...
    def run_prompt_optimization_whole_task(self, task_name: str, prompts_path: str,
        ...
        try:
            ...
            # Create an executor and run optimization for all experiments with prompts
            executor = OptimizationExecutor(self)
            results = executor.run_task_optimization(
                task=target_task,
                population_size=population_size,
    ...
    def run_prompt_optimization_using_task_experiment(self, task_name: str, experiment_name: str,
        ...
        try:
            ...
            # Create an executor and run optimization for a specific experiment with prompts
            executor = OptimizationExecutor(self)
            results = executor.run_single_experiment_optimization(
                task=target_task,
                experiment=target_experiment,
