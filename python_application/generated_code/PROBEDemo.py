...
optimization_task = [
    OptimizationTask(
        name="Genetic Algorithms - SAM ViT-L - Jaccard Optimization Metric",
        ...
        optimization_metric=Metric(
            name="Jaccard as an optimization metric", type=MetricType.JACCARD
        ),
        performance_metric=[
            Metric(
                name="Jaccard Index",
    ...
    OptimizationTask(
        name="Genetic Algorithms - SAM ViT-L - Dice Optimization Metric",
        description="Tarea de optimización mediante el uso de algoritmos genéticos",
        algorithm=OptimizationAlgorithm.GENETIC,
        foundation_model=FoundationModel(
            name="vit_l",
        ...
        optimization_metric=Metric(
            name="Dice as an optimization metric", type=MetricType.DICE
        ),
        performance_metric=[
            Metric(
                name="Jaccard Index",
    ...
    OptimizationTask(
        name="Genetic Algorithms - SAM ViT-L - SamScore Optimization Metric",
        description="Tarea de optimización mediante el uso de algoritmos genéticos",
        algorithm=OptimizationAlgorithm.GENETIC,
        foundation_model=FoundationModel(
            name="vit_l",
